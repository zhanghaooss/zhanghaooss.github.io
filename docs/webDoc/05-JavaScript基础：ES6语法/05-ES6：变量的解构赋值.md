...
* [x] 如果我们在赋值时，采用的是 `undefined`或者`null`，那会有什么区别呢？
...
<img src="https://raw.githubusercontent.com/zhanghaooss/clouding/master/img/image-20230323145149232.png" alt="image-20230323145149232" style="zoom:67%;" />

### 较为复杂的解构

![复杂解构](https://raw.githubusercontent.com/zhanghaooss/clouding/master/img/image-20230323151919404.png)
...
将右边 name 的值赋值给左边的 myName 变量，将右边 age 的值赋值给左边的 myAge 变量。
...
* 参数解构 参数为数组，函数均可
  ...
  function area2({ length: l, width: w, height: h }) {
      return (l * w + l * h + w * h) * 2;
  }
  console.log(area2(c1)); //2200
  ```
