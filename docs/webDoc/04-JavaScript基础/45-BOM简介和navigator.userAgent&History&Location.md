...
window系统的Chrome浏览器的userAgent是：

![image-20230322171530459](../../图床/image-20230322171530459.png)

我们还可以在电脑浏览器的控制台里可以添加很多设备，通过这种方式，可以模拟移动端浏览器的场景，非常有用，请务必掌握。操作如下：

（1）需要点击 edit，手动添加：

![](../../图床/qgyh/20191127_1903.png)

（2）添加时，根据 User agent 来识别不同的浏览器：

![](../../图床/qgyh/20191127_1918.png)
