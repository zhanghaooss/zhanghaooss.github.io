...
![]( D:/html5_folder/my-webdoc/图床/qgyh/20220725_2000.png)

### 定义

函数内的 arguments 是一个**类数组对象**，里面存储的是它接收到的**实参列表**。所有函数都内置了一个 arguments 对象，有个讲究的地方是：只有函数才有 arguments。
...
![]( D:/html5_folder/my-webdoc/图床/qgyh/20180125_2140.png)
