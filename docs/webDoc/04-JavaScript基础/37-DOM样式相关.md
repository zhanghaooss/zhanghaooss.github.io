...
- className（针对内嵌样式）
  ...
  > classList是一个数组提供了toggle方法切换类的有无
...
* classList: 通过构造函数生成的一个对象，提供了操作 classList的一系列方法
  * toggle
  * add
  * remove
