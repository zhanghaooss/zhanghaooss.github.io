...
![20221227170225](../..//图床/20221227170225.png)
...
<http://img.smyhvae.com/20190821_2101.png>![CSS Flexbox 可视化](../../图床/CSS Flexbox 可视化-1677114307445.png)
...
或者单个方向自动填充 例如为最后一个项目元素添加`margin-left:auto`，他就会跑到最后面
