...
end-{number} 对于右侧的位移位置,数值支持 0 50 100 分别指 0% 50% 100% ![1675912726608](../../图床/1675912726608.png)
...
**中心位置位移** .translate-middle 使用位移 x 轴 y 轴居中 底层源码：transform: translate(-50%, -50%) !important;
