...
关于”暂时性死区“的更多介绍，详本项目的另一篇文章《JavaScript之ES6语法：变量let、const和块级作用域.md》。[04-ES6：变量 let、const 和块级作用域](../05-JavaScript基础：ES6语法/04-ES6：变量 let、const 和块级作用域.md)
...
-   <u>如果用 const 声明引用数据类型（即“对象”），这里的“无法被修改”指的是**不能改变内存地址的引用**；但对象里的内容是可以被修改的。</u>
...
详见《JavaScript基础/对象简介.md》。[13-对象简介](../04-JavaScript基础/13-对象简介.md)
